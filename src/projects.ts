// src/projects.ts
// SOURCE OF TRUTH \u2014 pulled directly from live Wix subpages + each project's
// real live site. Order below matches the requested portfolio display order.
// NOTE: GoGal was removed \u2014 it wasn't included in the requested reorder list.
// If that was unintentional, let me know and I'll add it back in.
...
export const PROJECTS: Project[] = [
  {
    ...
    tags: ['Social Media', 'Website', 'Advertising'],
  ...
  {
    slug: 'sailing-portfolio',
    title: 'Sailing Portfolio',
    subtitle: 'Junior sailing recruiting portfolio \u2014 Ozzie Young',
    category: 'Website',
    tags: ['Website'],
    coverImg: 'https://ozzie-sailing.vercel.app/photos/photo1.jpg',
    galleryImgs: [],
    externalUrl: 'https://ozzie-sailing.vercel.app/',
    externalUrlLabel: 'Visit Website',
    problem: '',
    solution: '',
    stats: [],
  ...
  },
  {
    ...
    category: 'Social Media',
    tags: ['Social Media', 'Website', 'Branding'],
    coverImg:
