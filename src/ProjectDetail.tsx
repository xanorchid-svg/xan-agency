...
export default function ProjectDetail() {
  ...
  if (!project) {
    return (
      <div
        className="main-wrapper min-h-screen flex items-center justify-center"
        style={{ background: '#0c0c0c' }}
      >
        <div className="text-center">
          <p className="text-[#D7E2EA] font-medium mb-4">Project not found.</p>
          <Link to="/portfolio" className="text-[#D7E2EA] underline hover:opacity-70">
            Back to Portfolio
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="main-wrapper min-h-screen" style={{ background: '#0c0c0c' }}>
      ...
      >
        <p
          className="text-[#D7E2EA] text-xs uppercase tracking-widest mb-3"
          style={{ opacity: 0.45 }}
        >
          {project.category}
        </p>
        ...
        <p
          className="text-[#D7E2EA] font-light max-w-xl"
          style={{ opacity: 0.65, fontSize: 'clamp(1rem, 2vw, 1.3rem)' }}
        >
          {project.subtitle}
        </p>
        ...
        {project.externalUrl && (
          <a
            ...
            className="inline-block mt-6 rounded-full border-2 border-[#D7E2EA]
                       text-[#D7E2EA] px-7 py-2.5 text-sm font-medium uppercase
                       tracking-widest hover:bg-[#D7E2EA]/10 transition-colors"
          >
            Live Project ↗
          </a>
        )}
      ...
      <motion.div
        ...
        className="px-5 sm:px-8 md:px-10 mb-16"
      >
        <img
      ...
      {/* Problem / Solution */}
      <div
        className="px-5 sm:px-8 md:px-10 py-16 grid md:grid-cols-2 gap-10 md:gap-16
                   max-w-5xl mx-auto"
      >
        {[
          ...
          >
            <p
              className="text-[#D7E2EA] text-xs uppercase tracking-widest mb-4"
              style={{ opacity: 0.4 }}
            >
              {label}
            </p>
          ...
          <div className="grid grid-cols-3 gap-8 max-w-2xl mx-auto text-center">
            {project.stats.map((stat) => (
              <div key={stat.label}>
                ...
                <p
                  className="font-light text-sm mt-2 uppercase tracking-wide"
      ...
      {/* Image gallery — spec layout (40/60 split) */}
      <div className="px-5 sm:px-8 md:px-10 pb-20">
      ...
      {/* Prev / Next */}
      <div
        className="flex justify-between items-center px-5 sm:px-8 md:px-10 py-12 border-t"
      ...
      >
        <p
          className="text-[#D7E2EA] text-sm font-light text-center"
          style={{ opacity: 0.35 }}
        >
          © 2026 Xan Orchid
        </p>
