...
function CharSpan({
  ...
  const opacity = useTransform(
    scrollYProgress,
    [index / total, Math.min((index + 15) / total, 1)],
    [0.2, 1]
  );
  return (
...
// ─── MarqueeSection ────────────────────────────────────────────────────────────
// Uses Xan's 12 portfolio images instead of motionsites GIFs
...
function MarqueeSection() {
  ...
  // Row 1: first 11, tripled. Row 2: remaining, tripled.
  const row1 = [...MARQUEE_IMAGES.slice(0, 11), ...MARQUEE_IMAGES.slice(0, 11), ...MARQUEE_IMAGES.slice(0, 11)];
  const row2 = [...MARQUEE_IMAGES.slice(5), ...MARQUEE_IMAGES.slice(5), ...MARQUEE_IMAGES.slice(5)];
...
const TESTIMONIALS = [
  {
    quote:
      "I can't say enough about Alexandra Orchid's work. I hired her to build a website for my podcast and coaching business. I had a vague idea of what I wanted, and she took the ball and ran with it. Her work is beautiful, creative and pragmatic. Who could ask for more? I would hire Ms. Orchid again in a minute.",
    name: 'Marissa K.',
  ...
  {
    quote:
      "I can't say enough about Xan. She has helped us in many different roles — Social Media marketing, newsletters, blogs, infographics, and even building and maintaining our website. She is great at taking feedback and implements changes quickly and accurately. I highly recommend Xan.",
    name: 'David Diamond',
  ...
  {
    quote:
      "I've worked with Alexandra on several projects including pitch decks, paid media ads, social media posts, and promotional materials. She has a strong design eye, delivers efficiently and on time, and absorbs feedback quickly. Alexandra's a joy to work with — highly recommend.",
    name: 'Leo R.',
  ...
  {
    quote:
      "Our company worked with Xan to rebrand our fragrance website. She was so helpful and knowledgeable throughout the entire process. She gave us options and helped us choose the best one. She made sure we were completely satisfied. We would highly recommend her to anyone looking to rebrand.",
    name: 'Leen B.',
...
// ─── Featured 3 projects for homepage cards ─────────────────────────────────
const FEATURED = [PROJECTS[0], PROJECTS[6], PROJECTS[4]]; // DVC, Goddess, Abrago

// ─── ProjectCard (sticky stacking) ─────────────────────────────────────────
      ...
      >
        ...
        <div className="flex flex-wrap items-start justify-between gap-4 mb-5 md:mb-6">
          <div className="flex items-start gap-4 sm:gap-6">
            <span
              className="font-black leading-none hero-heading flex-shrink-0"
          ...
          {project.externalUrl ? (
            <a
              ...
              className="rounded-full border-2 border-[#D7E2EA] text-[#D7E2EA]
                         ...
                         hover:bg-[#D7E2EA]/10 transition-colors flex-shrink-0"
            >
              Live Project
            </a>
          ) : (
...
function ContactForm() {
  ...
  if (sent) {
    return (
      ...
      >
        <p className="text-[#D7E2EA] font-medium uppercase tracking-wide text-xl">
          Message received!
        </p>
        <p className="text-[#D7E2EA] font-light mt-3" style={{ opacity: 0.5 }}>
          Xan will be in touch soon.
        </p>
      </motion.div>
    );
  }
    ...
    <div className="flex flex-col gap-4 max-w-xl mx-auto">
      <div className="flex gap-4">
        <input
          ...
          className="flex-1 bg-transparent border border-[#D7E2EA]/20 rounded-xl
                     px-4 py-3 text-[#D7E2EA] font-light placeholder-[#D7E2EA]/30
      ...
      <input
        ...
        className="bg-transparent border border-[#D7E2EA]/20 rounded-xl
                   px-4 py-3 text-[#D7E2EA] font-light placeholder-[#D7E2EA]/30
                   focus:outline-none focus:border-[#D7E2EA]/50 transition-colors"
      />
      <textarea
        ...
        className="bg-transparent border border-[#D7E2EA]/20 rounded-xl
                   px-4 py-3 text-[#D7E2EA] font-light placeholder-[#D7E2EA]/30
                   focus:outline-none focus:border-[#D7E2EA]/50 transition-colors resize-none"
      />
  ...
  return (
    <div className="main-wrapper">
      ...
      >
          ...
          <FadeIn delay={0.15} y={40} once={false}>
            <h1
              className="hero-heading font-black uppercase tracking-tight
                         leading-none whitespace-nowrap w-full
        ...
        {/* Portrait — centered absolute, Magnet effect */}
        <div
      ...
      <section
        ...
        style={{ background: '#0c0c0c' }}
      >
        {/* Corner decorative portfolio images */}
        {/* Top-left */}
        <FadeIn
          delay={0.1}
          x={-80}
        ...
        >
          <img
            src="https://static.wixstatic.com/media/b80b05_3cc09fce62da4a83b087e02c2df13e0b~mv2.png/v1/fit/w_400,h_400,q_90,enc_avif,quality_auto/b80b05_3cc09fce62da4a83b087e02c2df13e0b~mv2.png"
            alt=""
        ...
        >
          <img
            src="https://static.wixstatic.com/media/b80b05_2305bdcff38f45baa939ff183c6ae499~mv2.png/v1/fit/w_400,h_400,q_90,enc_avif,quality_auto/b80b05_2305bdcff38f45baa939ff183c6ae499~mv2.png"
            alt=""
            className="w-full rounded-2xl"
          />
        </FadeIn>
        ...
        >
          <img
            src="https://static.wixstatic.com/media/b80b05_d701bdcad664423c8ca381b760b91c56~mv2.png/v1/fit/w_400,h_400,q_90,enc_avif,quality_auto/b80b05_d701bdcad664423c8ca381b760b91c56~mv2.png"
            alt=""
            className="w-full rounded-2xl"
          />
        </FadeIn>
        ...
        >
          <img
            src="https://static.wixstatic.com/media/b80b05_9d859e430f874acdb67af939ed2e5a36~mv2.jpg/v1/fit/w_400,h_400,q_90,enc_avif,quality_auto/b80b05_9d859e430f874acdb67af939ed2e5a36~mv2.jpg"
            alt=""
            className="w-full rounded-2xl"
          />
        </FadeIn>
      ...
      >
        ...
        <FadeIn delay={0.2} y={0}>
          <div className="text-center mb-12">
            <Link
              to="/portfolio"
              className="text-[#D7E2EA] uppercase tracking-widest text-sm
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <p
                ...
                style={{ color: '#0c0c0c', fontSize: 'clamp(0.85rem, 1.5vw, 1.1rem)' }}
              >
                {TESTIMONIALS[activeTestimonial].name}
              </p>
              <p style={{ color: '#0c0c0c', opacity: 0.45, fontSize: '0.85rem' }}>
      ...
      >
        ...
        <FadeIn delay={0.2} y={0}>
          <p
            className="text-[#D7E2EA] text-center font-light uppercase tracking-wide mb-12"
            style={{ opacity: 0.45, fontSize: 'clamp(0.85rem, 1.4vw, 1.1rem)' }}
          >
      ...
      >
        <div className="flex flex-col sm:flex-row justify-between items-center gap-5">
          <p
            className="text-[#D7E2EA] font-light text-sm"
            style={{ opacity: 0.35 }}
          >
            © 2026 Xan Orchid. All rights reserved.
          </p>
          <div className="flex gap-8">
            <Link
              to="/portfolio"
              className="text-[#D7E2EA] text-sm uppercase tracking-wider
                         font-medium hover:opacity-70 transition-opacity"
            >
              Portfolio
            </Link>
          ...
          <div className="flex gap-5">
            {[
              { label: 'Instagram', href: 'https://www.instagram.com/graphix.xan' },
              { label: 'LinkedIn', href: 'https://www.linkedin.com/in/xan-orchid/' },
              { label: 'Upwork', href: 'https://www.upwork.com/freelancers/~01b1742c39720ba911' },
            ].map(({ label, href }) => (
              <a
                key={label}
                href={href}
