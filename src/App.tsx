...
const TESTIMONIALS = [
  ...
  { quote: "Working with Xan has been an incredible experience. She supported the marketing efforts for Perfeqtion Imaging & Real Health MD with creativity, professionalism, and exceptional attention to detail. From editing engaging reels for Dr. Jenn with B-roll, to designing beautiful carousel posts and promotional flyers for our email campaigns, every project was delivered on time and exceeded our expectations. Xan is hardworking, reliable, and truly talented. She consistently produces high-quality work and brings fresh ideas to every project. It was a pleasure working with her, and we highly recommend her to anyone looking for a skilled marketing and creative professional.", name: 'Aubry Merkle', company: 'Perfeqtion Imaging & Real Health MD (Dr. Jenn Simmons)' },
];
